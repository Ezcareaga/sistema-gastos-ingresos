...
import static com.contable.domain.BankAccountAsserts.*;
...
class BankAccountResourceIT {
    ...
    public static BankAccount createEntity() {
        return new BankAccount().name(DEFAULT_NAME).accountNumber(DEFAULT_ACCOUNT_NUMBER).balance(DEFAULT_BALANCE);
    }
    ...
    public static BankAccount createUpdatedEntity() {
        return new BankAccount().name(UPDATED_NAME).accountNumber(UPDATED_ACCOUNT_NUMBER).balance(UPDATED_BALANCE);
    }
    ...
    void putExistingBankAccount() throws Exception {
        ...
        updatedBankAccount.name(UPDATED_NAME).accountNumber(UPDATED_ACCOUNT_NUMBER).balance(UPDATED_BALANCE);
    ...
    void fullUpdateBankAccountWithPatch() throws Exception {
        ...
        partialUpdatedBankAccount.name(UPDATED_NAME).accountNumber(UPDATED_ACCOUNT_NUMBER).balance(UPDATED_BALANCE);
