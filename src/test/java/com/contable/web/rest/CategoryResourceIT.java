...
import static com.contable.domain.CategoryAsserts.*;
...
import com.contable.domain.enumeration.CategoryType;
...
class CategoryResourceIT {
    ...
    private static final CategoryType DEFAULT_TYPE = CategoryType.INCOME;
    private static final CategoryType UPDATED_TYPE = CategoryType.EXPENSE;
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).type(DEFAULT_TYPE);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).type(UPDATED_TYPE);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).type(UPDATED_TYPE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).type(UPDATED_TYPE);
