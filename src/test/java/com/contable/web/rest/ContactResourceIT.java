...
import static com.contable.domain.ContactAsserts.*;
...
class ContactResourceIT {
    ...
    public static Contact createEntity() {
        return new Contact().name(DEFAULT_NAME).identification(DEFAULT_IDENTIFICATION).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
    }
    ...
    public static Contact createUpdatedEntity() {
        return new Contact().name(UPDATED_NAME).identification(UPDATED_IDENTIFICATION).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    }
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.name(UPDATED_NAME).identification(UPDATED_IDENTIFICATION).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.name(UPDATED_NAME).identification(UPDATED_IDENTIFICATION).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
